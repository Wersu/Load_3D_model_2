...
TextRendering::TextRendering()
{
	...
	if (FT_Init_FreeType(&ft_lib)) 
		cout << "free type init error" << endl;
	...
	// use standart 4 byte represents the colors of a texture
	...
	shaders_text = ForShader::createProgram("shaders/text.vert", "shaders/text.frag");
}

...
private:
	...
	uint getPosition(float p_animation_time, const aiNodeAnim* p_node_anim);
	uint getRotation(float p_animation_time, const aiNodeAnim* p_node_anim);
	uint getScaling(float p_animation_time, const aiNodeAnim* p_node_anim);

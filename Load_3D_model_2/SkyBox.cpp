...
void SkyBox::init(char* folder)
{
	...
	GLfloat skybox_vertices[] = {      
		-cube_size,  cube_size, -cube_size, // forward
		...
		-cube_size,  cube_size, -cube_size, // up
		 cube_size,  cube_size, -cube_size,
		 cube_size,  cube_size,  cube_size,
		 cube_size,  cube_size,  cube_size,
		-cube_size,  cube_size,  cube_size,
		...
		-cube_size, -cube_size, -cube_size, // down
		 cube_size, -cube_size, -cube_size,
		 cube_size, -cube_size,  cube_size,
		 cube_size, -cube_size,  cube_size,
		-cube_size, -cube_size,  cube_size,
	...
	texture_id = createTexture(folder);

	skybox_shaders = ForShader::createProgram("shaders/skybox.vert", "shaders/skybox.frag");
}
...
GLuint SkyBox::createTexture(char* folder)
{
	GLuint text_id;
...
#undef FOURCC_DXT5
		...
		{
			glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BASE_LEVEL, 0);	 
			glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAX_LEVEL, mipmap_count);	 
